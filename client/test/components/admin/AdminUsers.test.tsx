...
describe('AdminUsers', () => {
  beforeEach(async () => {
    ...
    vi.mocked(api.get).mockImplementation(async (url) => {
      ...
      if (url === '/admin/users/7/leaderboards') return { data: { leaderboardHidden: false, entries: Array.from({ length: 6 }, (_, index) => ({ mode: index % 2 ? 'multi' : 'single', difficulty: ['easy', 'normal', 'hard'][Math.floor(index / 2)], rank: index + 1, totalRanked: 10, total: 2, wins: 1, winRate: 0.5, avgGuesses: 2 })) } } as never;
