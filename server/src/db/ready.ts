...
const REQUIRED_COLUMNS: Record<string, string[]> = {
  ...
  mouse_difficulties: ['mouse_id', 'difficulty_key'],
  mouse_change_submissions: ['id', 'api_token_id', 'api_token_name', 'created_at'],
  mouse_change_items: [
    'id',
    'submission_id',
    'mouse_id',
  ...
  games: ['id', 'session_id', 'user_id', 'guest_key', 'target_mouse_id', 'mode', 'guesses', 'guess_times', 'first_guess_mouse_id', 'status', 'guess_count'],
  match_records: [
    'id',
    'room_id',
    'db_type',
